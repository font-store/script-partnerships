...
class GrantsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Clients', 'Partnerships', 'Pays']
        ];
    ...
    public function add()
    {
        ...
        $clients = $this->Grants->Clients->find('list', ['limit' => 200]);
        $partnerships = $this->Grants->Partnerships->find('list', ['limit' => 200]);
        $pays = $this->Grants->Pays->find('list', ['limit' => 200]);
        $this->set(compact('grant', 'clients', 'partnerships', 'pays'));
        $this->set('_serialize', ['grant']);
    }
